...
#
# Script generated by Vivado on Fri Oct 06 16:57:51 +0100 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Q08toBCD.sh
...
#
# Usage        : Q08toBCD.sh
#                Q08toBCD.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Q08toBCD.sh [-reset_run]
#                Q08toBCD.sh [-reset_log]
#                Q08toBCD.sh [-help]
#
...
# script info
echo -e "Q08toBCD.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Q08toBCD.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Q08toBCD xil_defaultlib.Q08toBCD xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Q08toBCD -key {Behavioral:sim_1:Functional:Q08toBCD} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Q08toBCD.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Q08toBCD.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Q08toBCD.sh [-help]\n\
Usage: Q08toBCD.sh [-step]\n\
Usage: Q08toBCD.sh [-lib_map_path]\n\
Usage: Q08toBCD.sh [-reset_run]\n\
Usage: Q08toBCD.sh [-reset_log]\n\
Usage: Q08toBCD.sh [-keep_index]\n\
Usage: Q08toBCD.sh [-noclean_files]\n\n\
