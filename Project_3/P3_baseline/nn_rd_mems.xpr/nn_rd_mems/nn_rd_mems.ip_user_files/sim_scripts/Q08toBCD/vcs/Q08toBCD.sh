...
#                script (type 'Q08toBCD.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Q08toBCD xil_defaultlib.glbl -o Q08toBCD_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Q08toBCD_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Q08toBCD_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Q08toBCD_simv.daidir vcs_lib c.obj)
