...
#
# Script generated by Vivado on Fri Oct 06 16:49:29 +0100 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : images_mem.sh
...
#
# Usage        : images_mem.sh
#                images_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                images_mem.sh [-reset_run]
#                images_mem.sh [-reset_log]
#                images_mem.sh [-help]
#
...
# script info
echo -e "images_mem.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./images_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot images_mem xil_defaultlib.images_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim images_mem -key {Behavioral:sim_1:Functional:images_mem} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb images_mem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./images_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: images_mem.sh [-help]\n\
Usage: images_mem.sh [-step]\n\
Usage: images_mem.sh [-lib_map_path]\n\
Usage: images_mem.sh [-reset_run]\n\
Usage: images_mem.sh [-reset_log]\n\
Usage: images_mem.sh [-keep_index]\n\
Usage: images_mem.sh [-noclean_files]\n\n\
