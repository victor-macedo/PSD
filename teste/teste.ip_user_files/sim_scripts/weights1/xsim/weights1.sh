...
#
# Script generated by Vivado on Fri Oct 27 18:53:55 +0100 2023
...
# script info
echo -e "weights1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot weights1 xil_defaultlib.weights1 xil_defaultlib.glbl -log elaborate.log
}
