...
#
# Script generated by Vivado on Wed Nov 01 14:37:15 +0000 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : weights1.sh
...
#
# Usage        : weights1.sh
#                weights1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                weights1.sh [-reset_run]
#                weights1.sh [-reset_log]
#                weights1.sh [-help]
#
...
# script info
echo -e "weights1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./weights1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot weights1 xil_defaultlib.weights1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim weights1 -key {Behavioral:sim_1:Functional:weights1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb weights1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./weights1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: weights1.sh [-help]\n\
Usage: weights1.sh [-step]\n\
Usage: weights1.sh [-lib_map_path]\n\
Usage: weights1.sh [-reset_run]\n\
Usage: weights1.sh [-reset_log]\n\
Usage: weights1.sh [-keep_index]\n\
Usage: weights1.sh [-noclean_files]\n\n\
