...
#
# Script generated by Vivado on Wed Nov 01 14:37:10 +0000 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : weights2.sh
...
#
# Usage        : weights2.sh
#                weights2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                weights2.sh [-reset_run]
#                weights2.sh [-reset_log]
#                weights2.sh [-help]
#
...
# script info
echo -e "weights2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./weights2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot weights2 xil_defaultlib.weights2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim weights2 -key {Behavioral:sim_1:Functional:weights2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb weights2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./weights2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: weights2.sh [-help]\n\
Usage: weights2.sh [-step]\n\
Usage: weights2.sh [-lib_map_path]\n\
Usage: weights2.sh [-reset_run]\n\
Usage: weights2.sh [-reset_log]\n\
Usage: weights2.sh [-keep_index]\n\
Usage: weights2.sh [-noclean_files]\n\n\
